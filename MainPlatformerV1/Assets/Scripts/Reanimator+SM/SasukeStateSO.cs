...
namespace MainGame {
    ...
    public class SasukeStateSO : BaseState<SasukeController, SasukeStateSO> {
        ...
        public SasukeStateSO(string stateName, State<SasukeController>[] states,
            Transition<SasukeController, SasukeStateSO>[] transitions, Action<SasukeController> enterStateEvent,
            Action<SasukeController> exitStateEvent, Action<SasukeController> updateStateEvent,
            Action<SasukeController> physicsUpdateStateEvent) : base(stateName, states, transitions, enterStateEvent,
            exitStateEvent, updateStateEvent, physicsUpdateStateEvent) { }
