...
public class PlayerController : MonoBehaviour, ISaveable {
    [Header("Input")] public InputProvider inputProvider;
    ...
    [Header("Getting a whooping")] public Vector2 hitForce;
    public FixedStopwatch hitStopwatch = new FixedStopwatch();
    public Collision2D collisionData;

    [Header("Giving a whooping")] public float dashSpeed = 12;
    ...
    private void Update()
    {
        inputState = inputProvider;
        stateMachine.Update();
        Debug.Log("Movement Direction: " + inputState.movementDirection + "\n IsCrouching: " + inputState.isCrouching);
    }
